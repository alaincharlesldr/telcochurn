"""Exploratory Data Analysis demo for Telco Customer Churn Dataset.

This module demonstrates the use of the DataAnalyzer class for exploratory data analysis on the Telco Customer Churn dataset.
"""
